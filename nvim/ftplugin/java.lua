...
local root_markers = { 'gradlew', 'mvnw', '.git', 'build.xml' }
...
local jdtlsconfig = {
		...
		java = {
			format = {
				settings = {
					...
					url = home .. "/dotfiles/misc/java-google-styleguide.xml",
					profile = "GoogleStyle",
				},
			},
				...
				runtimes = {
					{
						...
						name = "JavaSE-20",
						path = home .. "/.jenv/versions/20.0",
					},
					{
						name = "JavaSE-11",
						path = home .. "/.jenv/versions/11.0",
					},
					{
						name = "JavaSE-1.7",
						path = home .. "/.jenv/versions/1.7"
					},
				}
			},
			project = {
	...
	cmd = {
		home .. "/.jenv/versions/20.0/bin/java",
